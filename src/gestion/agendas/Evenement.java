...
public class Evenement {
	...
	public String toString(){
		return(this.getNom()+" de l'agenda "+this.getAgenda().getNom()+" : du "+this.formatterDate(this.getDateHeureDebut())+" au "+this.formatterDate(this.getDateHeureFin())+"  à "+this.getLieu()+"\n");
	}
}
